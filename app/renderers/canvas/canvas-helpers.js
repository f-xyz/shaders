define(function(require) {
    return {
         ...
         */
        rectangle: function (x, y, w, h, radius) {
            if (!radius) {
                this.moveTo(x, y);
                this.lineTo(x + w, y);
                this.lineTo(x + w, y + h);
         ...
         */
        text: function (text, x, y, maxWidth, lineHeight, adjustLetterSpacing) {
